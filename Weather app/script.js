...
function changeBg(status) {
    if (status === 'Clouds') {
        ...
        document.body.style.backgroundImage = 'url(snowyweather.jpg)';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(sunnyweather.jpg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(thunderstromweather.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(drizzleweather.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(mistweather.jpg)';
    }
